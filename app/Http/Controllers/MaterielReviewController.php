...
class MaterielReviewController extends Controller
{
    /**
    ...
    {
        $reviews=MaterielReview::getAllReview();
    ...
    public function store(Request $request)
    {
        ...
        $materiel_info=Materiel::getMaterielBySlug($request->slug);
        //  return $materiel_info;
        // return $request->all();
        $data=$request->all();
        $data['materiel_id']=$materiel_info->id;
        $data['user_id']=$request->user()->id;
        $data['status']='active';
        // dd($data);
        $status=MaterielReview::create($data);
    ...
    public function update(Request $request, $id)
    {
        ...
        if($review){
            ...
            // return $user;
            // $details=[
            //     'title'=>'Update Materiel Rating!',
            //     'actionURL'=>route('materiel-detail',$materiel_info->id),
            //     'fas'=>'fa-star'
            // ];
            // Notification::send($user,new StatusNotification($details));
            if($status){
