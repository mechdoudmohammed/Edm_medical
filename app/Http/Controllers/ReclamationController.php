...
class ReclamationController extends Controller
    ...
    // les reclamation sur les orders de ventes
{
    ...
    // les reclamation sur les orders de location

    public function createloc($id){
        $order=Location::find($id);
         return view('user.reclamationloc.create')->with('order',$order);
    }

   

    public function saveloc(Request $req, $id ){
        $this->validate($req,[
            'type_reclamation'=>'required',
            'msg_reclamation'=>'required',
            'user_id'=>'required',
