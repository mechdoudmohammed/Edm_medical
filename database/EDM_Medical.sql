...
INSERT INTO `fournisseurs` (`id`, `title`, `slug`, `status`, `created_at`, `updated_at`) VALUES
...
(6, 'Fournisseur', 'fournisseur', 'active', '2020-08-17 20:50:31', '2020-08-17 20:50:31');
...
INSERT INTO `carts` (`id`, `materiel_id`, `order_id`, `user_id`, `price`, `status`, `quantity`, `amount`, `created_at`, `updated_at`) VALUES
...
(1, 'Men\'s Fashion', 'mens-fashion', NULL, '/storage/photos/1/Categorie/mini-banner1.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:26:15', '2020-08-14 04:26:15'),
(2, 'Women\'s Fashion', 'womens-fashion', NULL, '/storage/photos/1/Categorie/mini-banner2.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:26:40', '2020-08-14 04:26:40'),
(3, 'Kid\'s', 'kids', NULL, '/storage/photos/1/Categorie/mini-banner3.jpg', 1, NULL, NULL, 'active', '2020-08-14 04:27:10', '2020-08-14 04:27:42'),
...
(4, '2020_07_10_021010_create_fournisseurs_table', 1),
(5, '2020_07_10_025334_create_banners_table', 1),
(6, '2020_07_10_112147_create_categories_table', 1),
(7, '2020_07_11_063857_create_materiels_table', 1),
(8, '2020_07_12_073132_create_post_categories_table', 1),
(9, '2020_07_12_073701_create_post_tags_table', 1),
(10, '2020_07_12_083638_create_posts_table', 1),
(11, '2020_07_13_151329_create_messages_table', 1),
(12, '2020_07_14_023748_create_livraisons_table', 1),
(13, '2020_07_15_054356_create_orders_table', 1),
(14, '2020_07_15_102626_create_carts_table', 1),
(15, '2020_07_16_041623_create_notifications_table', 1),
(16, '2020_07_16_053240_create_coupons_table', 1),
(17, '2020_07_23_143757_create_wishlists_table', 1),
(18, '2020_07_24_074930_create_materiel_reviews_table', 1),
...
('5e91e603-024e-45c5-b22f-36931fef0d90', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{\"title\":\"New Materiel Rating!\",\"actionURL\":\"http:\\/\\/localhost:8000\\/materiel-detail\\/white-sports-casual-t\",\"fas\":\"fa-star\"}', NULL, '2020-08-15 07:44:07', '2020-08-15 07:44:07'),
...
('e28b0a73-4819-4016-b915-0e525d4148f5', 'App\\Notifications\\StatusNotification', 'App\\User', 1, '{\"title\":\"New Materiel Rating!\",\"actionURL\":\"http:\\/\\/localhost:8000\\/materiel-detail\\/lorem-ipsum-is-simply\",\"fas\":\"fa-star\"}', NULL, '2020-08-17 21:08:16', '2020-08-17 21:08:16'),
...
INSERT INTO `orders` (`id`, `order_number`, `user_id`, `sub_total`, `livraison_id`, `coupon`, `total_amount`, `quantity`, `payment_method`, `payment_status`, `status`, `first_name`, `last_name`, `email`, `phone`, `country`, `post_code`, `address1`, `address2`, `created_at`, `updated_at`) VALUES
...
(5, 'Post Categorie', 'post-categorie', 'active', '2020-08-15 06:59:04', '2020-08-15 06:59:04');
...
--
-- Dumping data for table `materiel_reviews`
--

INSERT INTO `materiel_reviews` (`id`, `user_id`, `materiel_id`, `rate`, `review`, `status`, `created_at`, `updated_at`) VALUES
(1, 3, 2, 5, 'nice materiel', 'active', '2020-08-15 07:44:05', '2020-08-15 07:44:05'),
...
INSERT INTO `livraisons` (`id`, `type`, `price`, `status`, `created_at`, `updated_at`) VALUES
...
ALTER TABLE `fournisseurs`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `fournisseurs_slug_unique` (`slug`);
...
ALTER TABLE `carts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `carts_materiel_id_foreign` (`materiel_id`),
...
ALTER TABLE `orders`
  ...
  ADD KEY `orders_livraison_id_foreign` (`livraison_id`);
...
ALTER TABLE `materiels`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `materiels_slug_unique` (`slug`),
  ADD KEY `materiels_fournisseur_id_foreign` (`fournisseur_id`),
  ADD KEY `materiels_cat_id_foreign` (`cat_id`),
  ADD KEY `materiels_child_cat_id_foreign` (`child_cat_id`);

--
-- Indexes for table `materiel_reviews`
--
ALTER TABLE `materiel_reviews`
  ADD PRIMARY KEY (`id`),
  ADD KEY `materiel_reviews_user_id_foreign` (`user_id`),
  ADD KEY `materiel_reviews_materiel_id_foreign` (`materiel_id`);
...
ALTER TABLE `wishlists`
  ADD PRIMARY KEY (`id`),
  ADD KEY `wishlists_materiel_id_foreign` (`materiel_id`),
...
--
-- AUTO_INCREMENT for table `materiel_reviews`
--
ALTER TABLE `materiel_reviews`
...
ALTER TABLE `carts`
  ...
  ADD CONSTRAINT `carts_materiel_id_foreign` FOREIGN KEY (`materiel_id`) REFERENCES `materiels` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_livraison_id_foreign` FOREIGN KEY (`livraison_id`) REFERENCES `livraisons` (`id`) ON DELETE SET NULL,
...
--
ALTER TABLE `materiels`
  ADD CONSTRAINT `materiels_fournisseur_id_foreign` FOREIGN KEY (`fournisseur_id`) REFERENCES `fournisseurs` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `materiels_cat_id_foreign` FOREIGN KEY (`cat_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `materiels_child_cat_id_foreign` FOREIGN KEY (`child_cat_id`) REFERENCES `categories` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `materiel_reviews`
--
ALTER TABLE `materiel_reviews`
  ADD CONSTRAINT `materiel_reviews_materiel_id_foreign` FOREIGN KEY (`materiel_id`) REFERENCES `materiels` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `materiel_reviews_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `wishlists`
  ...
  ADD CONSTRAINT `wishlists_materiel_id_foreign` FOREIGN KEY (`materiel_id`) REFERENCES `materiels` (`id`) ON DELETE CASCADE,
