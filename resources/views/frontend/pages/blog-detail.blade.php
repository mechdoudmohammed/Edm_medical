                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">			
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Poster un commentaire </h2>
                                        <!-- Comment Form -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group button">
                                                        <button type="submit" class="btn"><span class="comment_btn comment">commenter</span><span class="comment_btn reply" style="display: none;">Repondre </span></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </form>
                            ...
                            <p class="text-center p-5">
                               Vous ave besoin de  <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> ou  <a style="color:blue" href="{{route('register.form')}}">inscription</a> pour commenter 
