...
<style type="text/css">
  ...
  <section class="order_details pt-3">
    ...
    <table class="table table-bordered table-stripe">
      ...
      @php 
        $materiel=DB::table('materiels')->select('title')->where('id',$cart->materiel_id)->get();
        $materiel_discount=DB::table('materiels')->select('discount')->where('id',$cart->materiel_id)->get();
      @endphp
        <tr>
          <td><span>
