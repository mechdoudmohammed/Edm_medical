 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            ...
            @endphp 
                <tr>
                    ...
                    <td>
                        <a href="{{route('order.show',$order->id)}}" class="btn btn-warning btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="Afficher" data-placement="bottom"><i class="fas fa-eye"></i></a>
        ...
        @else
          <h6 class="text-center">Aucune commande trouvée !!! Veuillez commander du matériel</h6>
        @endif
      </div>
    </div>
</div>
