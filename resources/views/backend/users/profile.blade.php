        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    <div class="image">
                        @if($profile->photo)
                        <img class="card-img-top img-fluid roundend-circle mt-4" style="border-radius:50%;height:80px;width:80px;margin:auto;" src="../backend/img/Profile_admin/{{$profile->photo}}" alt="profile picture">
                        @else
                    ...
                    <h5 class="card-title text-left"><small>Information:</small></h5>
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('profile-update',$profile->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input id="inputTitle" type="text" name="name" placeholder="Enter un nom"  value="{{$profile->name}}" class="form-control">
                      @error('name')
