...
@section('title','Edm Medical | Tableau de bord')
          ...
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                ...
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Categorie::countActiveCategory()}}</div>
              </div>
              <div class="col-auto">
      ...
      <div class="col-xl-3 col-md-6 mb-4">
        <div class="card border-left-success shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Materiels</div>
                <div class="h5 mb-0 font-weight-bold text-gray-800">{{\App\Models\Materiel::countActiveMateriel()}}</div>
              </div>
              <div class="col-auto">
...
<script type="text/javascript">
  ...
  function drawChart()
  {
      ...
      var options = {
          title : 'Utilisateur enregistré au cours des 7 derniers jours'
      };
  ...
  {{-- line chart --}}
  <script type="text/javascript">
    const url = "{{route('materiel.order.income')}}";
