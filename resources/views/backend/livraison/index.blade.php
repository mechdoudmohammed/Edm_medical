...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Liste de Livraison</h6>
      <a href="{{route('livraison.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i>Ajouter un type de livraison</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($livraisons as $livraison)   
                <tr>
                    ...
                    <td>{{$livraison->price}}MAD</td>
                    <td>
                        @if($livraison->status=='active')
                            <span class="badge badge-success">{{$livraison->status}}</span>
                        @else
                            <span class="badge badge-warning">{{$livraison->status}}</span>
                        @endif
                    </td>
                    <td>
