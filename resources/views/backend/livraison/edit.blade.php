...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('livraison.update',$livraison->id)}}">
        ...
        <input id="inputTitle" type="text" name="type" placeholder="Enter type"  value="{{$livraison->type}}" class="form-control">
        @error('title')
        ...
        <input id="price" type="number" name="price" placeholder="Entrer prix"  value="{{$livraison->price}}" class="form-control">
        @error('price')
        <span class="text-danger">{{$message}}</span>
        @enderror
        </div>        
